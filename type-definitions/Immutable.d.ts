...
declare module Immutable {
  ...
  export function get<TProps, K extends keyof TProps, NSV = undefined>(record: Record<TProps>, key: K, notSetValue?: NSV): TProps[K] | NSV;
  export function get<V, NSV = undefined>(collection: Array<V>, key: number, notSetValue?: NSV): V | NSV;
  export function get<C extends Object, K extends keyof C, NSV = undefined>(object: C, key: K, notSetValue?: NSV): C[K] | NSV;
